...
const lightStyle = () => {
    ...
    $("#navbar").css("top", "0px");
    $("#btn-ac, #btn-search").removeClass("btn-outline-light");
    $("#btn-ac, #btn-search").addClass("btn-outline-dark");
...
const darkStyle = () => {
    ...
    $("#navbar").css("top", "-6px");
    $("#btn-ac, #btn-search").removeClass("btn-outline-dark");
    $("#btn-ac, #btn-search").addClass("btn-outline-light");
